<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SidebarMenu.ascx.cs" Inherits="SiparisYonetimi.WebFormsUI.Moduller.SidebarMenu" %>
...
<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/Admin/SliderYonetimi.aspx">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/Admin/KategoriYonetimi.aspx">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/Admin/UrunYonetimi.aspx">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/Admin/MusteriYonetimi.aspx">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/Admin/KullaniciYonetimi.aspx">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/Admin/MarkaYonetimi.aspx">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layers align-text-bottom" aria-hidden="true">
                        <polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg>
                    Marka Yönetimi
                </a>
